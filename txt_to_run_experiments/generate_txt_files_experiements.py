...
print("algo - dataset - epochs - noise type - multiplicator - power - n_freeriders - redo")
...
l_epochs=[5,20]
l_noise_type=["FL 1 1", "plain 1 1","disguised 1 1",
    "disguised 1 0.5","disguised 1 2",
    "disguised 3 1","disguised 3 0.5","disguised 3 2"]
l_fr=[1,5,45]
l_force=["False"]
...
for algo,dataset, epochs,noise_type, n_fr,force in product(l_algo,l_dataset,
    l_epochs,l_noise_type,l_fr,l_force):
