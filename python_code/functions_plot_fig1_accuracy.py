...
def figure_1_accuracy_params(n_epochs):
    ...
    if n_epochs==5:
        params_iid["n_iter"]*=2
        params_shard["n_iter"]*=2
        params_shak["n_iter"]*=2
        
    params_iid["exp_specific"]=(f"{params_iid['n_clients']}_{params_iid['samples']}"
          +f"_{params_iid['epochs']}_{params_iid['n_iter']}"
          +f"_{params_iid['lr']}")
    ...
    params_shak["exp_specific"]=(f"{params_shak['n_clients']}"
          +f"_{params_shak['epochs']}_{params_shak['n_iter']}"
          +f"_{params_shak['lr']}")
    
    
    FA_iid=load_dataset_algo("MNIST-iid","FedAvg",params_iid["exp_specific"],params_iid)
    FP_iid=load_dataset_algo("MNIST-iid","FedProx",params_iid["exp_specific"],params_iid)
    ...
    FA_shak=load_dataset_algo("shakespeare","FedAvg",params_shak["exp_specific"],params_shak)
    FP_shak=load_dataset_algo("shakespeare","FedProx",params_shak["exp_specific"],params_shak)
