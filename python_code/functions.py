...
def get_n_iter(dataset:str,E:int,n_freeriders:int):
    ...
    if E==5: 
        if dataset=="MNIST-iid" :n_iter=200
        elif dataset=="MNIST-shard":n_iter = 300
        elif dataset=="CIFAR-10":n_iter=150
        elif dataset=="shakespeare":n_iter=100
        
    elif E==20:
        if dataset=="MNIST-iid" :n_iter=100
        elif dataset=="MNIST-shard":n_iter = 150
        elif dataset=="CIFAR-10":n_iter=75
        elif dataset=="shakespeare":n_iter=50
    
    if n_freeriders==5:n_iter*=2
    elif n_freeriders==45:n_iter*=3
