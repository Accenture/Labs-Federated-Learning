...
class Server:
    ...
    def __init__(self, args: dict):
        ...
        # GLOBAL MODEL
        self.model_0, self.loss_f = load_model(
            self.dataset_name, self.model_type, self.seed
        )
        self.g_model = deepcopy(self.model_0)
        self.accum_model = deepcopy(self.model_0)
    ...
    def forget_Wr(self, W_r: list[int]):
        ...
        # IF CLIENTS TO UNLEARN
            ...
            self.r += 1
            self.t = 0
            self.n_aggregs.append(int(self.p_rework * self.T))
            self.hists_increase()
